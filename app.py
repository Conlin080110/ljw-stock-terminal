...
POPULAR_STOCKS = {
    ...
    "맥쿼리인프라": {"symbol": "088980", "code": "00587274", "shares": 400000000, "market": "KOSPI", "sector": "인프라펀드", "beta": 0.28, "div": 6.4},
...
# ---------------------------------------------------------
# [탭 12] 🔥 AI ProPicks (PRO 유료 전용 기능 - 관리자 해제)
# ---------------------------------------------------------
...
# ---------------------------------------------------------
# [탭 15] 🔔 핀포인트 조건 알림 (PRO 유료 전용 기능 - 관리자 해제)
# ---------------------------------------------------------
else:
